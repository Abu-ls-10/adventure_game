...
//        this.isVisited = false;
        ...
        this.portal[0] = portalX;
        this.portal[1] = portalY;
    }
    ...
    public String getObjectString() {
        ...
        if (!this.objectsInRoom.isEmpty()) {
            res += this.objectsInRoom.get(0).getDescription();
            for (int i = 1; i < this.objectsInRoom.size(); i++) {
                res += ", " + this.objectsInRoom.get(i).getDescription();
            }
        }
        return res;
    }
...
//        String res = "";
//        if (!this.motionTable.getDirection().isEmpty()) {
//            res += this.motionTable.getDirection().get(0).getDirection();
//            for (int i = 1; i < this.motionTable.getDirection().size(); i++) {
//                res = res + ", " + this.motionTable.getDirection().get(i).getDirection();
//            }
//        }
//        return res;
//    }
