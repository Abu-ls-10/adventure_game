    ...
    private void parseRooms() throws IOException {
        ...
        while (buff.ready()) {
            ...
            while (line != null && !line.equals("")) {
                ...
                String direction = part[0].trim();
                String t = part[1].trim();

                portalX = Integer.parseInt(t.substring(1, 2));
                portalY = Integer.parseInt(t.substring(3, 4));

                String key = part[2].trim();
                line = buff.readLine();
            }

            // now we make the room object
            Room room = new Room(roomName, roomNumber, roomDescription, adventureName, portalX, portalY);
